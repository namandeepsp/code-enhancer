...
from api.ai import AIProvider, MockAIProvider, DeepSeekProvider, GeminiProvider
...
def get_ai_provider() -> AIProvider:
    ...
    # AI_PROVIDER env var selects the provider — defaults to gemini
    ...
    # Default: Gemini with gemini-2.0-flash primary, gemini-1.5-flash fallback
